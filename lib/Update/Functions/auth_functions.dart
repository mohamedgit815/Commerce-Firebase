...
class AuthFunctions {
  ...
  static Future<void> signOut(BuildContext context) async {
    return await showDialog(context: context, builder: (BuildContext context)=>AlertDialog(
      title: CustomText(text: '${translateText(textSure, context)}',),
      actions: [
        CustomOutlinedButton(onPressed: (){
          Navigator.pop(context);
        }, child: CustomText(text: '${translateText(textNo, context)}',)),


        CustomOutlinedButton(onPressed: ()async {
          await firebaseAuth.signOut();
          return await SystemNavigator.pop();
        }, child: CustomText(text: '${translateText(textYes, context)}',)),
      ],
    ));
