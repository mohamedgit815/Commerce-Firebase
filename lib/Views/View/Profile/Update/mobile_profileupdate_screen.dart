...
import 'package:commerce/Update/Functions/profile_funcations.dart';
import 'package:commerce/Update/State/image_state.dart';
      ...
      child: Directionality(
        ...
        child: WillPopScope(
          ...
          child: Scaffold(
            appBar: AppBar(
              centerTitle: true,
              title: CustomText(text: '${translateText(textUpdate, context)}',
              fontSize: 20.0,
                      ...
                      Expanded(
                        ...
                        child: DefaultTextFormField(
                          controller: _firstController,
                            validator: (String? v){
                              return !regExpName.hasMatch(v.toString()) ? 'Enter the First Name' : null;
                      ...
                      Expanded(
                        ...
                        child: DefaultTextFormField(
                          controller: _lastController,
                            validator: (String? v){
                              return !regExpName.hasMatch(v.toString()) ? 'Enter the Last Name' : null;
                            },
                            inputType: TextInputType.name,
                            inputAction: TextInputAction.next ,
                          hint: 'Last Name',
